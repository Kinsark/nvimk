    ...
    config = function()
      ...
      autocmd('BufWinEnter', {
        ...
        callback = function()
          ...
          vim.keymap.set('n', '<leader>p', function() vim.cmd.Git 'push' end, { buffer = bufnr, remap = false, desc = '[G]it [P]ush' })

          vim.keymap.set('n', '<leader>P', function() vim.cmd.Git { 'pull', '--rebase' } end, { buffer = bufnr, remap = false, desc = '[G]it [P]ull' })
